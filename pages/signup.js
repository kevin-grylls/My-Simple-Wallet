...
import { Form, Button, Container, Divider, Header, Segment } from 'semantic-ui-react'
import API from '../api';
...
export default class SignupPage extends Component {
    ...
    updateAllErrors = () => this.setState({
        idError: this.state.email == null ? true : false,
        passwordError: this.state.password == null ? true : false,
    })

    updateError = targetName => this.setState({ idError: false, passwordError: false, [targetName + "Error"]: true })
